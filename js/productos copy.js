document.addEventListener('DOMContentLoaded', async function () {
  ...
  function normalizarSrc(imagen) {
    ...
    const esAbsoluta = imagen.startsWith('http://') || imagen.startsWith('https://');
    return esAbsoluta ? imagen : '../' + imagen;
  }
  ...
  const icono = btn.querySelector('.icono-agregar');
  if (!icono) return;

  // Reiniciar animación si ya está activa
  icono.classList.remove('animado');
